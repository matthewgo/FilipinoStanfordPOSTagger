...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		String inputFile = "data/distsim/sentences.tok.words";
		String outputFile = "data/distsim/distsim-Tagalog-Moses-100mb.txt";
		String stanfordOutputFile = "data/distsim/distsim-Stanford-Tagalog-Moses-100mb.txt";
