...
public class TrainFileCreatorMain {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		// HPOSTandStanfordFormatConverter.HPOSTToStanford(Constants.TRAIN_HPOST_WORDS,
		// Constants.TRAIN_HPOST_TAGS,
		// Constants.TRAIN_STANFORD, true);
		// HPOSTandStanfordFormatConverter.HPOSTToStanford(Constants.TEST_HPOST_WORDS,
		// Constants.TEST_HPOST_TAGS,
